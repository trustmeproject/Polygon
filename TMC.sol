/**
 * Official Website : https://trustmeproject.tech
 * Telegram : https://t.me/trustmeofficial
 * Medium : https://trustmeproject.medium.com/
 * Twitter : https://twitter.com/projecttrustme
 * github : https://github.com/trustmeproject
 */ 
...
contract TMC is ERC20, Pausable, ERC20Detailed {
    
	address teamWallet = 0xAE3AACf45553FB6c86D3649a59f730c8DD8ef0a7;
    address serviceWallet = 0xB2A919E90A70609ff6947E3Bc2D81A1e8bCB14E8;
    address partnerWallet = 0x6740160f37F4650a5D8671aD30d117e0d9BbF136;
    address airdropWallet = 0x4A3A82a3f176b0589f9Db64028578fe5247FaF70;
	...
	constructor() public ERC20Detailed("TRUSTMECOIN", "TMC", 9) {  
	        
       
        totalCoins = 30000000 * 10 ** uint256(decimals());
        _mint(owner(), totalCoins); // total supply fixed at 30 million coins
        
        ERC20.transfer(teamWallet, 6000000 * 10 ** uint256(decimals()));  
        ERC20.transfer(partnerWallet, 6000000 * 10 ** uint256(decimals()));
        ERC20.transfer(serviceWallet, 3000000 * 10 ** uint256(decimals()));
        ERC20.transfer(airdropWallet, 3000000 * 10 ** uint256(decimals()));
